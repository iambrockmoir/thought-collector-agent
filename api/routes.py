...
pinecone.init(
    ...
    environment="aped-4627-b74a"  # This is from your host URL
)

# Get the index
index_name = "thoughts-index-qt78i74"  # Full index name from your host URL

# Add debug logging
logger.info(f"Initializing Pinecone with environment: aped-4627-b74a")
